...
class UserRecoveryForm extends CFormModel {
    ...
    public function rules() {
        return array(
            ...
            array('login_or_email', 'match', 'pattern' => '/^[A-Za-z0-9\._-]+@[A-Za-z0-9\._-]+.([a-zA-Z]{2,4})$/', 'message' => Yii::t("user", "Incorrect symbols (A-z0-9).")),
//            array('login_or_email', 'match', 'pattern' => '/^[.-,]$/', 'message' => Yii::t("user", "Incorrect symbols (A-z0-9).")),
