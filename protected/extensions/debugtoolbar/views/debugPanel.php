...
<div id="yiiWebDebugToolbar" onmouseover="yiiDebugMouse(true);" onmouseout="yiiDebugMouse(false);">
    ...
    <?php if (isset($item['content']) && !is_null($item['content'])) $index++;
endforeach ?>
    </ul>
...
<script type="text/javascript">
    ...
    function yiiWebDebugToggleVisible(element) {
        _$(element).style.display = (_$(element).style.display == 'block') ? 'none' : 'block';
    }
    ...
    function yiiWebDebugToggle(element)
    {
        ...
        {
            if (_curPanel != '' && disp == 'none')
                _$(_curPanel).style.display = 'none';
<?php if ($opaque): ?>
