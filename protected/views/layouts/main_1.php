...
<html lang="en">
    ...
    <body>
        ...
        <div class="container marketing">
            ...
            <!--            <hr class="featurette-divider">
                        ...
                        <div class="row featurette">
                            ...
                            <div class="col-md-5">
                                <img class="featurette-image img-responsive" src="<?php echo Yii::app()->request->baseUrl; ?>/images/posts/koala.jpg" alt="Generic placeholder image">
                            </div>
                        </div>
                        ...
                        <div class="row featurette">
                            <div class="col-md-5">
                                <img class="featurette-image img-responsive" src="<?php echo Yii::app()->request->baseUrl; ?>/images/posts/Penguins.jpg" alt="Generic placeholder image">
                            </div>
                            <div class="col-md-7">
        ...
        <!--        <div class="container">
                    <div class="row">
                        <div class="col-xs-12 block-blue"></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4 block-gray"></div>
                        <div class="col-xs-8 block-yellow"></div>
                    </div>
                </div>-->
