...
<?php echo $form->errorSummary($model, NULL, NULL, array()); ?>
    <div class="form-group">
        ...
        <div class="form-group">
        <?php echo $form->labelEx($model,'cidade_id', array('class'=>'col-sm-2 control-label')); ?>
        <div class="col-sm-10">
            <?php echo $form->textField($model,'cidade_id', array('class'=>'form-control', 'placeholder' => 'Cidade Id')); ?>
            <?php echo $form->error($model,'cidade_id', array('class'=>'help-block')); ?>
        </div>
    </div>
    <div class="form-group">
