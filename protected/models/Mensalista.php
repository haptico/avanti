...
/**
 * This is the model class for table "mensalista".
 *
 * The followings are the available columns in table 'mensalista':
 * @property integer $id
 ...
 * @property Users $user
 */
class Mensalista extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, trajeto_id, ponto_id, data_inicio', 'required'),
			array('user_id, trajeto_id, ponto_id', 'numerical', 'integerOnly'=>true),
			array('data_fim', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, trajeto_id, ponto_id, data_inicio, data_fim', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Mensalista the static model class
	 */
