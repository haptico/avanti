        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                try {
                    ...
                    // Coloca a marca��o de linha em todas as tabelas que implementam a classe Display.
                        ...
                        <? /*if ($DESENVOLVEDOR) { ?>
                            <li id="department">
                                <form name="ch_dep" id="ch_dep" action="" method="post">
                                    <?
                                    $depts = array("CPTFA", "GP", "LP", "Prevendas", "Elaborador CPCOM", 'MW Planning', 'Gest�o', 'Vendas', 'Fiber', 'Configura��o', 'Tim Fixo');
                            ...
                            if ($opt) {
                                switch ($opt) {
                                    ...
                                    default:
                                        ...
                                        // se tem '?' � pq tem querystring, entao popula um array chamado $arrParams com a key->value dos gets
